...
class Configuration(object):
    def __init__(self, **kwargs):
        ...
        self.websocket_port = int(
            os.getenv("CAH_WEBSOCKET_PORT", os.getenv("CAH_PORT", 8765))
        )
        self.server_port = int(
            os.getenv("CAH_SERVER_PORT", os.getenv("CAH_PORT", 8765))
        )
        self.server_proxy_port = int(
            os.getenv("CAH_SERVER_PROXY_PORT", os.getenv("CAH_PORT", 8765))
        )
